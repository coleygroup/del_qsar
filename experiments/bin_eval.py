...
flags.DEFINE_enum('threshold_type', 'percentile', ['percentile', 'fixed'], 'Threshold type')
flags.DEFINE_float('threshold_val', 99.5, 'Threshold value (exact value or percentile)')
...
def main(argv):
    ...
    if 'DD1S_CAIX' in FLAGS.csv and not FLAGS.random_guess:
        RESULTS_FILE = os.path.join(SAVE_ROOT, f'DD1S_CAIX_{FLAGS.model_type}_bin_eval_{FLAGS.threshold_type}_{FLAGS.threshold_val}.csv')
    elif 'DD1S_CAIX' in FLAGS.csv and FLAGS.random_guess:
        RESULTS_FILE = os.path.join(SAVE_ROOT, f'DD1S_CAIX_random_guess_bin_eval_{FLAGS.threshold_type}_{FLAGS.threshold_val}.csv')
        
    elif 'sEH' in FLAGS.exp[0] and not FLAGS.random_guess:
        RESULTS_FILE = os.path.join(SAVE_ROOT, f'triazine_sEH_{FLAGS.model_type}_bin_eval_{FLAGS.threshold_type}_{FLAGS.threshold_val}.csv')
    elif 'sEH' in FLAGS.exp[0] and FLAGS.random_guess:
        RESULTS_FILE = os.path.join(SAVE_ROOT, f'triazine_sEH_random_guess_bin_eval_{FLAGS.threshold_type}_{FLAGS.threshold_val}.csv')
        
    elif 'SIRT2' in FLAGS.exp[0] and not FLAGS.random_guess:
        RESULTS_FILE = os.path.join(SAVE_ROOT, f'triazine_SIRT2_{FLAGS.model_type}_bin_eval_{FLAGS.threshold_type}_{FLAGS.threshold_val}.csv')
    elif 'SIRT2' in FLAGS.exp[0] and FLAGS.random_guess:
        RESULTS_FILE = os.path.join(SAVE_ROOT, f'triazine_SIRT2_random_guess_bin_eval_{FLAGS.threshold_type}_{FLAGS.threshold_val}.csv')
    ...
    for i in range(len(_splitters)):
        ...
        roc_aucs_R, roc_aucs_R_lb, pr_aucs_R, pr_aucs_R_lb = [], [], [], []
