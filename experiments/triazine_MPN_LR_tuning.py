...
flags.DEFINE_integer('n_trials', 4, 'Number of optuna trials to run')
...
def objective(trial):
    ...
    INIT_LR_IDX = trial.suggest_int('init_lr_idx', low=0, high=3, step=1)
    init_lrs = [1e-5, 3e-5, 1e-4, 3e-4]
    INIT_LR = init_lrs[INIT_LR_IDX]
